            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fa fa-building-o"></i> Update Departments
                    </div>
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('agents[]',$agents, $employeeDepartments, ['class' => 'form-control selectpicker', 'multiple' => true, 'data-live-search' => 'true']) !!}
                    </div>
                    <div class="form-group">
