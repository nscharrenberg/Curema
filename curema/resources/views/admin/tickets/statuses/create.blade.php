            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fa fa-ticket"></i> Add Ticket Status
                    </div>
                    <div class="card-body">
                    {!! Form::open(['method' => 'POST', 'action' => 'AdminTicketStatusController@store']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::submit('Add Ticket Status', ['class' => 'btn btn-primary']) !!}
                    </div>
